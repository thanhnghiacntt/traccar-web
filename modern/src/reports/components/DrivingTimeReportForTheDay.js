...
const DrivingTimeReportForTheDay = ({ keyTitle }) => {
  ...
  const handleSearch = () => {
    ...
    fetch(`/api/reports/summary?&daily=true&from=${fromDateTime}&to=${toDateTime}&deviceId=${vehicleId}`, {
      method: 'GET',
      headers: {
...
export default DrivingTimeReportForTheDay;
