...
import {
  FormControl, InputLabel, Select, MenuItem, Table, TableHead, TableRow, TableCell, TableBody, IconButton,
} from '@mui/material';
    ...
    switch (key) {
      ...
      case 'attributes':
        switch (item.type) {
          ...
          case 'media':
            return (<ImageViewer src={`/api/media/${devices[item.deviceId]?.uniqueId}/${item.attributes.file}`} />);
          case 'commandResult':
