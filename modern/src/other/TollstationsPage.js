...
import TollstationList from './TollstationList';
import MapTollstationEdit from '../map/draw/MapTollstationEdit';
...
const TollstationsPage = () => {
  ...
  const [selectedtollstationId, setSelectedTollstationId] = useState();
    ...
    <div className={classes.root}>
      <div className={classes.content}>
        ...
        >
          ...
          <Divider />
          <TollstationList onStationSelected={setSelectedTollstationId} />
        </Drawer>
        <div className={classes.mapContainer}>
          <MapView>
            <MapTollstationEdit selectedTollstationId={selectedtollstationId} />
          </MapView>
          <MapCurrentLocation />
          <MapGeocoder />
        </div>
...
export default TollstationsPage;
