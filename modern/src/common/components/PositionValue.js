...
import {
  formatAlarm, formatAltitude, formatCourse, formatDirection, formatBoolean, formatCoordinate, formatDistance, formatNumber, formatNumericHours, formatPercentage, formatSpeed, formatTime,
} from '../util/formatter';
...
const PositionValue = ({ position, property, attribute }) => {
  ...
  const formatValue = () => {
    switch (key) {
      ...
      case 'course':
        return `${formatDirection(value, t)}\t${formatCourse(value)}`;
      case 'altitude':
